...
const inputText = document.getElementById("output-text");
...
function speak(text) {
    ...
    // Optionally, you can configure speech settings here, like voice, rate, pitch, etc.
    // speechUtterance.voice = someVoice;
...
if ('webkitSpeechRecognition' in window || 'SpeechRecognition' in window) {
    ...
    inputtext.value = "Speech recognition not supported in this browser.";
}